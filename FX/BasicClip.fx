...
{
	if (dot(pin.PosW-gClipPlanePosition, gClipPlaneNormal) >= gClipPlaneThreshold)
		clip(-1);
...
technique11 Light3TexDepthBias
{
    pass P0
    {
        SetVertexShader( CompileShader( vs_5_0, VS() ) );
